    ...
    <div className="min-h-screen w-full bg-slate-950 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Sign in to your Synapse account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <label className="text-[11px] font-semibold uppercase tracking-widest text-slate-500">Password</label>
            ...
            >
              {loading ? (
                <><Icon type="sync" className="!text-[16px] animate-spin" /> Signing in...</>
              ) : (
                <><Icon type="login" className="!text-[16px]" /> Sign In</>
              )}
            </button>
          </form>
